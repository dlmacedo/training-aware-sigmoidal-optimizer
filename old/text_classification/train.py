...
def train_and_valid(lr_, sub_train_, sub_valid_):
    ...
    train_data = DataLoader(sub_train_, batch_size=batch_size, shuffle=True, collate_fn=generate_batch, num_workers=args.num_workers)
...
if __name__ == "__main__":
    ...
    #train_dataset, test_dataset = text_classification.DATASETS['YelpReviewFull'](root=data, ngrams=args.ngrams)
    ################################################################################################################
    ################################################################################################################
    train_dataset, test_dataset = datasets.YelpReviewFull()
    model = TextSentiment(len(train_dataset.get_vocab()), embed_dim, len(train_dataset.get_labels())).to(device)
    ################################################################################################################
    ################################################################################################################
