...
#python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.001_e100_w0.0001_m0.9_nf" -gpu 0 -x 1 -bs 64
#python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.005_e100_w0.0001_m0.9_nf" -gpu 0 -x 1 -bs 64
...
#python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.001_e100_w0.0001_m0.9_nt" -gpu 0 -x 1 -bs 64
#python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.005_e100_w0.0001_m0.9_nt" -gpu 0 -x 1 -bs 64
...
#python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.001_e100_w0_m0.9_nf" -gpu 0 -x 1 -bs 64
#python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.005_e100_w0_m0.9_nf" -gpu 0 -x 1 -bs 64
...
#python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.001_e100_w0_m0.9_nt" -gpu 0 -x 1 -bs 64
#python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.005_e100_w0_m0.9_nt" -gpu 0 -x 1 -bs 64
