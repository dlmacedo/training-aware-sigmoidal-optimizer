...
python train.py -ei="pretune" -et "cnn_train" -ec "data~svhn+model~resnet34+optim~rmsprop_l0.01_e100_w0_m0.9_cf_a0.99" -gpu 0
python train.py -ei="pretune" -et "cnn_train" -ec "data~svhn+model~resnet34+optim~rmsprop_l0.01_e100_w0.0001_m0.9_cf_a0.99" -gpu 0
python train.py -ei="pretune" -et "cnn_train" -ec "data~svhn+model~resnet34+optim~rmsprop_l0.01_e100_w0_m0.9_ct_a0.99" -gpu 0
python train.py -ei="pretune" -et "cnn_train" -ec "data~svhn+model~resnet34+optim~rmsprop_l0.01_e100_w0.0001_m0.9_ct_a0.99" -gpu 0
python train.py -ei="pretune" -et "cnn_train" -ec "data~svhn+model~resnet34+optim~rmsprop_l0.01_e100_w0_m0_cf_a0.99" -gpu 0
python train.py -ei="pretune" -et "cnn_train" -ec "data~svhn+model~resnet34+optim~rmsprop_l0.01_e100_w0.0001_m0_cf_a0.99" -gpu 0
python train.py -ei="pretune" -et "cnn_train" -ec "data~svhn+model~resnet34+optim~rmsprop_l0.01_e100_w0_m0_ct_a0.99" -gpu 0
python train.py -ei="pretune" -et "cnn_train" -ec "data~svhn+model~resnet34+optim~rmsprop_l0.01_e100_w0.0001_m0_ct_a0.99" -gpu 0
