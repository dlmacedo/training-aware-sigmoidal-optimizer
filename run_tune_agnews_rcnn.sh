...
#python train.py -ei="tune" -et "cnn_train" -ec "data~agnews+model~rcnn+optim~sgd_l0.001_e20_w0.0001_m0.9_nf" -gpu 0 -x 1 -bs 32
#python train.py -ei="tune" -et "cnn_train" -ec "data~agnews+model~rcnn+optim~sgd_l0.005_e20_w0.0001_m0.9_nf" -gpu 0 -x 1 -bs 32
...
#python train.py -ei="tune" -et "cnn_train" -ec "data~agnews+model~rcnn+optim~sgd_l0.001_e20_w0.0001_m0.9_nt" -gpu 0 -x 1 -bs 32
#python train.py -ei="tune" -et "cnn_train" -ec "data~agnews+model~rcnn+optim~sgd_l0.005_e20_w0.0001_m0.9_nt" -gpu 0 -x 1 -bs 32
...
#python train.py -ei="tune" -et "cnn_train" -ec "data~agnews+model~rcnn+optim~sgd_l0.001_e20_w0_m0.9_nf" -gpu 0 -x 1 -bs 32
#python train.py -ei="tune" -et "cnn_train" -ec "data~agnews+model~rcnn+optim~sgd_l0.005_e20_w0_m0.9_nf" -gpu 0 -x 1 -bs 32
...
#python train.py -ei="tune" -et "cnn_train" -ec "data~agnews+model~rcnn+optim~sgd_l0.001_e20_w0_m0.9_nt" -gpu 0 -x 1 -bs 32
#python train.py -ei="tune" -et "cnn_train" -ec "data~agnews+model~rcnn+optim~sgd_l0.005_e20_w0_m0.9_nt" -gpu 0 -x 1 -bs 32
