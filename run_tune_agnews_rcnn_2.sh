...
python train.py -ei="tune" -et "cnn_train" -ec "data~agnews+model~rcnn+optim~rmsprop_l0.1_e10_w0.0001_m0_cf_a0.99" -gpu 1 -x 1 -bs 32
python train.py -ei="tune" -et "cnn_train" -ec "data~agnews+model~rcnn+optim~rmsprop_l0.05_e10_w0.0001_m0_cf_a0.99" -gpu 1 -x 1 -bs 32
python train.py -ei="tune" -et "cnn_train" -ec "data~agnews+model~rcnn+optim~rmsprop_l0.01_e10_w0.0001_m0_cf_a0.99" -gpu 1 -x 1 -bs 32
python train.py -ei="tune" -et "cnn_train" -ec "data~agnews+model~rcnn+optim~rmsprop_l0.005_e10_w0.0001_m0_cf_a0.99" -gpu 1 -x 1 -bs 32
python train.py -ei="tune" -et "cnn_train" -ec "data~agnews+model~rcnn+optim~rmsprop_l0.001_e10_w0.0001_m0_cf_a0.99" -gpu 1 -x 1 -bs 32
python train.py -ei="tune" -et "cnn_train" -ec "data~agnews+model~rcnn+optim~rmsprop_l0.1_e10_w0_m0_cf_a0.99" -gpu 1 -x 1 -bs 32
python train.py -ei="tune" -et "cnn_train" -ec "data~agnews+model~rcnn+optim~rmsprop_l0.05_e10_w0_m0_cf_a0.99" -gpu 1 -x 1 -bs 32
python train.py -ei="tune" -et "cnn_train" -ec "data~agnews+model~rcnn+optim~rmsprop_l0.01_e10_w0_m0_cf_a0.99" -gpu 1 -x 1 -bs 32
python train.py -ei="tune" -et "cnn_train" -ec "data~agnews+model~rcnn+optim~rmsprop_l0.005_e10_w0_m0_cf_a0.99" -gpu 1 -x 1 -bs 32
python train.py -ei="tune" -et "cnn_train" -ec "data~agnews+model~rcnn+optim~rmsprop_l0.001_e10_w0_m0_cf_a0.99" -gpu 1 -x 1 -bs 32
python train.py -ei="tune" -et "cnn_train" -ec "data~agnews+model~rcnn+optim~rmsprop_l0.1_e10_w0.0001_m0_ct_a0.99" -gpu 1 -x 1 -bs 32
python train.py -ei="tune" -et "cnn_train" -ec "data~agnews+model~rcnn+optim~rmsprop_l0.05_e10_w0.0001_m0_ct_a0.99" -gpu 1 -x 1 -bs 32
python train.py -ei="tune" -et "cnn_train" -ec "data~agnews+model~rcnn+optim~rmsprop_l0.01_e10_w0.0001_m0_ct_a0.99" -gpu 1 -x 1 -bs 32
python train.py -ei="tune" -et "cnn_train" -ec "data~agnews+model~rcnn+optim~rmsprop_l0.005_e10_w0.0001_m0_ct_a0.99" -gpu 1 -x 1 -bs 32
python train.py -ei="tune" -et "cnn_train" -ec "data~agnews+model~rcnn+optim~rmsprop_l0.001_e10_w0.0001_m0_ct_a0.99" -gpu 1 -x 1 -bs 32
python train.py -ei="tune" -et "cnn_train" -ec "data~agnews+model~rcnn+optim~rmsprop_l0.1_e10_w0_m0_ct_a0.99" -gpu 1 -x 1 -bs 32
python train.py -ei="tune" -et "cnn_train" -ec "data~agnews+model~rcnn+optim~rmsprop_l0.05_e10_w0_m0_ct_a0.99" -gpu 1 -x 1 -bs 32
python train.py -ei="tune" -et "cnn_train" -ec "data~agnews+model~rcnn+optim~rmsprop_l0.01_e10_w0_m0_ct_a0.99" -gpu 1 -x 1 -bs 32
python train.py -ei="tune" -et "cnn_train" -ec "data~agnews+model~rcnn+optim~rmsprop_l0.005_e10_w0_m0_ct_a0.99" -gpu 1 -x 1 -bs 32
python train.py -ei="tune" -et "cnn_train" -ec "data~agnews+model~rcnn+optim~rmsprop_l0.001_e10_w0_m0_ct_a0.99" -gpu 1 -x 1 -bs 32
