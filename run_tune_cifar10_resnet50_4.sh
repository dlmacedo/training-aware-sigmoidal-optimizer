...
python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l1_e100_w0.0001_m0.9_nf" -gpu 1 -x 1 -bs 64
python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.5_e100_w0.0001_m0.9_nf" -gpu 1 -x 1 -bs 64
...
python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l1_e100_w0.0001_m0.9_nt" -gpu 1 -x 1 -bs 64
python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.5_e100_w0.0001_m0.9_nt" -gpu 1 -x 1 -bs 64
...
python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l1_e100_w0_m0.9_nf" -gpu 1 -x 1 -bs 64
python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.5_e100_w0_m0.9_nf" -gpu 1 -x 1 -bs 64
...
python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l1_e100_w0_m0.9_nt" -gpu 1 -x 1 -bs 64
python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.5_e100_w0_m0.9_nt" -gpu 1 -x 1 -bs 64
