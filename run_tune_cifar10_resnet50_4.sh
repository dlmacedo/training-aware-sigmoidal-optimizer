...
#python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~adagrad_l0.005_e100_w0.0001_d0_a0" -gpu 0 -x 1 -bs 64
#python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~adagrad_l0.001_e100_w0.0001_d0_a0" -gpu 0 -x 1 -bs 64
...
#python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~adagrad_l0.005_e100_w0_d0_a0" -gpu 0 -x 1 -bs 64
#python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~adagrad_l0.001_e100_w0_d0_a0" -gpu 0 -x 1 -bs 64
...
#python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~adagrad_l0.005_e100_w0.0001_d0_a0.1" -gpu 0 -x 1 -bs 64
#python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~adagrad_l0.001_e100_w0.0001_d0_a0.1" -gpu 0 -x 1 -bs 64
...
#python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~adagrad_l0.005_e100_w0_d0_a0.1" -gpu 0 -x 1 -bs 64
#python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~adagrad_l0.001_e100_w0_d0_a0.1" -gpu 0 -x 1 -bs 64
...
#python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.001_e100_w0.0001_m0.9_nf" -gpu 1 -x 1 -bs 64
#python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.005_e100_w0.0001_m0.9_nf" -gpu 1 -x 1 -bs 64
#python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.1_e100_w0.0001_m0.9_nf" -gpu 1 -x 1 -bs 64
#python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.05_e100_w0.0001_m0.9_nf" -gpu 1 -x 1 -bs 64
python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.01_e100_w0.0001_m0.9_nf" -gpu 1 -x 1 -bs 64
#python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.001_e100_w0.0001_m0.9_nt" -gpu 1 -x 1 -bs 64
#python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.005_e100_w0.0001_m0.9_nt" -gpu 1 -x 1 -bs 64
#python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.1_e100_w0.0001_m0.9_nt" -gpu 1 -x 1 -bs 64
python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.05_e100_w0.0001_m0.9_nt" -gpu 1 -x 1 -bs 64
python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.01_e100_w0.0001_m0.9_nt" -gpu 1 -x 1 -bs 64
python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.001_e100_w0_m0.9_nf" -gpu 1 -x 1 -bs 64
python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.005_e100_w0_m0.9_nf" -gpu 1 -x 1 -bs 64
python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.1_e100_w0_m0.9_nf" -gpu 1 -x 1 -bs 64
python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.05_e100_w0_m0.9_nf" -gpu 1 -x 1 -bs 64
python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.01_e100_w0_m0.9_nf" -gpu 1 -x 1 -bs 64
python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.001_e100_w0_m0.9_nt" -gpu 1 -x 1 -bs 64
python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.005_e100_w0_m0.9_nt" -gpu 1 -x 1 -bs 64
python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.1_e100_w0_m0.9_nt" -gpu 1 -x 1 -bs 64
python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.05_e100_w0_m0.9_nt" -gpu 1 -x 1 -bs 64
python train.py -ei="tune" -et "cnn_train" -ec "data~cifar10+model~resnet50+optim~sgd_l0.01_e100_w0_m0.9_nt" -gpu 1 -x 1 -bs 64
