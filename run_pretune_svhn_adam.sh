...
python train.py -ei="pretune" -et "cnn_train" -ec "data~svhn+model~resnet34+optim~adam_l0.001_e100_w0_af_bf0.9_bs0.99" -gpu 1
python train.py -ei="pretune" -et "cnn_train" -ec "data~svhn+model~resnet34+optim~adam_l0.001_e100_w0.0001_af_bf0.9_bs0.99" -gpu 1
python train.py -ei="pretune" -et "cnn_train" -ec "data~svhn+model~resnet34+optim~adam_l0.001_e100_w0_at_bf0.9_bs0.99" -gpu 1
python train.py -ei="pretune" -et "cnn_train" -ec "data~svhn+model~resnet34+optim~adam_l0.001_e100_w0.0001_at_bf0.9_bs0.99" -gpu 1
